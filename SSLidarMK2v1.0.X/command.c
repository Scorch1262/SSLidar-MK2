...
void Wert_korrektur(void){                                              // "Wert_korrektur"
    ...
    if(range_mm_45 > 5000){                                             // fragt "range_mm_45" ab ob größer als 5000
    ...
    if(range_mm_135 > 5000){                                            // fragt "range_mm_135" ab ob größer als 5000
    ...
    if(range_mm_225 > 5000){                                            // fragt "range_mm_225" ab ob größer als 5000
    ...
    if(range_mm_315 > 5000){                                            // fragt "range_mm_315" ab ob größer als 5000
