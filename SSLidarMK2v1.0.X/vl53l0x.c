...
#define VL53L0X_Add_01      0x30
#define VL53L0X_Add_02      0x31
#define VL53L0X_Add_03      0x32
#define VL53L0X_Add_04      0x33
#define VL53L0X_Add_05      0x34
#define VL53L0X_Add_06      0x35
#define VL53L0X_Add_07      0x36
#define VL53L0X_Add_08      0x37
#define VL53L0X_Add_09      0x38
#define VL53L0X_Add_10      0x39
#define VL53L0X_Add_11      0x3A
#define VL53L0X_Add_12      0x3B
...
void VL53L0X_SetAdd(uint8_t new){
    ...
    writeBuffer[0] = I2C_SLAVE_DEVICE_ADDRESS;                                  // schreibt "I2C_SLAVE_DEVICE_ADDRESS" in "writeBuffer[0]"
	writeBuffer[1] = new;                                                       // schreibt "new" in "writeBuffer[1]"
	I2C1_MasterWrite(&writeBuffer[0], 2, Slave_Address, &status);               // schreibt 2 Byte (writeBuffer[0]) an I2C1
		i2c1_message_pending_100();                                             // ruft "i2c1_message_pending_100" auf
}
...
float VL53L0X_Millimeter_GetValue(uint8_t addr){                                // "VL53L0X_Millimeter_GetValue"
    ...
    Slave_Address = addr;                                                       // schreibt "STTS22H_ADDR" in "Slave_Address"
